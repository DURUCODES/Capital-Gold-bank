...
import business from "../public/image/loanimg.jpg";
  ...
  return (
    <div className="">
      <div
        ...
        className=""
      >
        <h1 className="text-[40px]  font-bold">Loans</h1>
      ...
      <div className="flex  flex-col justify-center  md:flex-row  md:p-20 md:justify-between my-10 px-5  items-center ">
        ...
        <div className="flex  flex-col">
          <h3 className="text-[#db2777] text-[20px] "> Our Loans</h3>
          <h1 className=" leading-9 mb-4 md:text-[40px] font-semibold ">
            Finance your next car
          </h1>
          <p>
            Are you looking for a car loan for a new or used vehicle? In
            minutes, find out if you're pre-qualified for financing with no
            influence on your credit score. Also, before visiting a
            participating dealer, make sure you understand your loan terms.
          </p>
          <h3 className="text-2xl font-semibold my-4">
            Over 700K+ approved loans
          </h3>
